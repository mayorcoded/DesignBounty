...
(function ($) {
  ...
  var classNames = {
    ...
    POPOVERHEADER: version.major === '4' ? 'popover-header-footer' : 'popover-title'
  }
  ...
  Selectpicker.prototype = {
      ...
      $selectOptions.each(function (index) {
        ...
        if (isOptgroup && thisData.divider !== true) {
          ...
          if (!this.previousElementSibling) { // Is it the first option of the optgroup?
            ...
            mainElements.push(generateLI(labelElement, null, 'dropdown-header-footer' + optGroupClass, optID));
            mainData.push({
    ...
    liHeight: function (refresh) {
      ...
      dropdownHeader.className = 'dropdown-header-footer';
    ...
    clickListener: function () {
      ...
      this.$menuInner.on('click', '.divider, .dropdown-header-footer', function (e) {
        e.preventDefault();
        e.stopPropagation();
        if (that.options.liveSearch) {
          that.$searchbox.focus();
